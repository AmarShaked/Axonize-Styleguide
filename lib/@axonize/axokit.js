...
var getTypeColors = function getTypeColors(type, theme) {
  ...
  switch (type) {
    ...
    case 'subtle':
      background = 'none';
      active = (0, _polished.darken)(0.05, theme.type === 'dark' ? 'rgba(0, 0, 0, 0.6)' : theme.main);
...
var StyledButton = exports.StyledButton = _styledComponents2.default.button(_templateObject5, function (_ref5) {
  ...
  return rounded && (0, _styledComponents.css)(_templateObject8);
}, function (_ref10) {
  var selected = _ref10.selected,
      theme = _ref10.theme;
  return selected && (0, _styledComponents.css)(_templateObject9, theme.main, theme.main);
}, function (_ref11) {
  var disabled = _ref11.disabled;
  return disabled && (0, _styledComponents.css)(_templateObject10, function (_ref12) {
    var type = _ref12.type;
    return ['link', 'subtle'].includes(type) && (0, _styledComponents.css)(_templateObject11);
  });
});
