(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("@axonize/axokit", ["React", "ReactDOM"], factory);
	else if(typeof exports === 'object')
		exports["@axonize/axokit"] = factory(require("react"), require("react-dom"));
	else
		root["@axonize/axokit"] = factory(root["React"], root["ReactDOM"]);
...
/* harmony import */ var rc_menu__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! rc-menu */ "./node_modules/rc-menu/es/index.js");
...
/* harmony import */ var _Option__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./Option */ "./node_modules/rc-select/es/Option.js");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./util */ "./node_modules/rc-select/es/util.js");
/* harmony import */ var _SelectTrigger__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./SelectTrigger */ "./node_modules/rc-select/es/SelectTrigger.js");
/* harmony import */ var _PropTypes__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./PropTypes */ "./node_modules/rc-select/es/PropTypes.js");
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./utils */ "./node_modules/rc-trigger/es/utils.js");
/* harmony import */ var rc_util_es_ContainerRender__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! rc-util/es/ContainerRender */ "./node_modules/rc-util/es/ContainerRender.js");
/* harmony import */ var rc_util_es_Portal__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! rc-util/es/Portal */ "./node_modules/rc-util/es/Portal.js");
...
var _styled = __webpack_require__(/*! ./styled */ "./src/components/Button/styled.js");

var _TrackingProvider = __webpack_require__(/*! ../../providers/TrackingProvider */ "./src/providers/TrackingProvider/index.js");
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          type = _props.type,
          rest = _objectWithoutProperties(_props, ['children', 'icon', 'loading', 'type']);
      ...
      return _react2.default.createElement(
        ...
        loading && _react2.default.createElement(_styled.ButtonSpinner, { type: type }),
        icon && _react2.default.createElement(_styled.ButtonIcon, { withText: !!children, loading: loading, className: icon }),
        children && _react2.default.createElement(
          _styled.ButtonContent,
          { loading: loading, withIcon: !!icon },
          children
        )
      );
    }
...
Button.propTypes = {
  ...
  type: _propTypes2.default.oneOf(['default', 'primary', 'subtle', 'link', 'danger', 'warning']),
...
exports.default = (0, _TrackingProvider.withTrack)(Button);
...
exports.StyledButton = exports.ButtonContent = exports.ButtonIcon = exports.ButtonSpinner = undefined;
...
var ButtonSpinner = exports.ButtonSpinner = (0, _styledComponents2.default)(_Spinner2.default)(_templateObject, function (_ref) {
  var type = _ref.type;
  return ['danger', 'warning', 'primary'].includes(type) ? '#fff' : '#616161';
});

var ButtonIcon = exports.ButtonIcon = _styledComponents2.default.i(_templateObject2, function (_ref2) {
  var loading = _ref2.loading;
  return loading ? 0 : 1;
});

var ButtonContent = exports.ButtonContent = _styledComponents2.default.span(_templateObject3, function (_ref3) {
...
var getTypeColors = function getTypeColors(type, theme) {
  ...
  switch (type) {
    case 'primary':
      ...
      hover = (0, _polished.lighten)(0.05, theme.main);
      active = (0, _polished.darken)(0.05, theme.main);
    ...
    case 'danger':
      ...
      color = '#fff';
      hover = (0, _polished.lighten)(0.05, 'rgb(222, 53, 11)');
      active = (0, _polished.darken)(0.05, 'rgb(222, 53, 11)');

      break;
    case 'warning':
      background = theme.type === 'dark' ? '#FF7600' : 'rgb(255, 171, 0)';
      color = '#fff';
      hover = (0, _polished.lighten)(0.05, theme.type === 'dark' ? '#FF7600' : 'rgb(255, 171, 0)');
      active = (0, _polished.darken)(0.05, theme.type === 'dark' ? '#FF7600' : 'rgb(255, 171, 0)');
  ...
  return (0, _styledComponents.css)(_templateObject4, background, color, hover, hoverColor, active);
};

var StyledButton = exports.StyledButton = _styledComponents2.default.button(_templateObject5, function (_ref5) {
  ...
  return float && (0, _styledComponents.css)(_templateObject6);
}, function (_ref8) {
  var type = _ref8.type,
      theme = _ref8.theme;
  return type === 'link' && (0, _styledComponents.css)(_templateObject7, theme.main);
}, function (_ref9) {
  var selected = _ref9.selected,
      theme = _ref9.theme;
  return selected && (0, _styledComponents.css)(_templateObject8, theme.main, theme.type === 'dark' ? 'rgb(18, 19, 21)' : theme.main, theme.type === 'dark' ? 'rgb(18, 19, 21)' : '#fff', theme.type === 'dark' ? 'rgb(18, 19, 21)' : '#fff', theme.main);
}, function (_ref10) {
  var disabled = _ref10.disabled;
  return disabled && (0, _styledComponents.css)(_templateObject9, function (_ref11) {
    var type = _ref11.type;
    return ['link', 'subtle'].includes(type) && (0, _styledComponents.css)(_templateObject10);
  });
});
...
var _styled = __webpack_require__(/*! ./styled */ "./src/components/ButtonGroup/styled.js");
 ...
 */
var ButtonGroup = function (_React$PureComponent) {
...
exports.StyledGroupItem = exports.StyledButtonGroup = undefined;
...
var StyledButtonGroup = exports.StyledButtonGroup = _styledComponents2.default.div(_templateObject);

var StyledGroupItem = exports.StyledGroupItem = _styledComponents2.default.div(_templateObject2);
...
var _style = __webpack_require__(/*! ./style */ "./src/components/Input/style/index.js");

var _style2 = _interopRequireDefault(_style);

var _TrackingProvider = __webpack_require__(/*! ../../providers/TrackingProvider */ "./src/providers/TrackingProvider/index.js");

var _search = __webpack_require__(/*! ./search */ "./src/components/Input/search.js");
...
var Input = function (_React$PureComponent) {
  ...
  function Input() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Input.__proto__ || Object.getPrototypeOf(Input)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (e) {
      ...
      if (track && trackingLabel && value) {
        ...
        _this.delayedTracking = (0, _debounce3.default)(function () {
          return track(trackingLabel, { value: value });
        }, 5000);
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      var _props = this.props,
          track = _props.track,
          trackingLabel = _props.trackingLabel,
          rest = _objectWithoutProperties(_props, ['track', 'trackingLabel']);

      return _react2.default.createElement(_style2.default, _extends({}, rest, { onChange: this.handleChange }));
    }
  }]);
...
var ExportedInput = (0, _TrackingProvider.withTrack)(Input);
ExportedInput.Search = _search2.default;
ExportedInput.TextArea = _textarea2.default;

exports.default = ExportedInput;
...
var Search = function (_React$PureComponent) {
  ...
  _createClass(Search, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_style.StyledSearch, _extends({}, rest, { onChange: this.handleChange }));
    }
  }]);
...
exports.default = (0, _TrackingProvider.withTrack)(Search);
...
exports.StyledTextArea = exports.StyledSearch = undefined;
...
var StyledSearch = exports.StyledSearch = (0, _styledComponents2.default)(_input2.default.Search)(_templateObject);

var StyledTextArea = exports.StyledTextArea = (0, _styledComponents2.default)(_input2.default.TextArea)(_templateObject2);

var StyledInput = (0, _styledComponents2.default)(_input2.default)(_templateObject2);
...
var TextArea = function (_React$PureComponent) {
  ...
  _createClass(TextArea, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_style.StyledTextArea, _extends({}, rest, { onChange: this.handleChange }));
    }
  }]);
...
exports.default = (0, _TrackingProvider.withTrack)(TextArea);
...
var _select3 = __webpack_require__(/*! ./style/select */ "./src/components/Select/style/select.js");

var _select4 = _interopRequireDefault(_select3);

var _option = __webpack_require__(/*! ./style/option */ "./src/components/Select/style/option.js");
...
var Select = function (_React$PureComponent) {
  ...
  function Select() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Select.__proto__ || Object.getPrototypeOf(Select)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (value, target) {
      var _this$props = _this.props,
          track = _this$props.track,
          onChange = _this$props.onChange,
          trackingLabel = _this$props.trackingLabel;
      ...
      if (track && trackingLabel && value) {
        track(trackingLabel, { value: value });
      }
  ...
  _createClass(Select, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_select4.default, _extends({}, rest, { onChange: this.handleChange }));
    }
  }]);
...
var exportedSelect = (0, _TrackingProvider.withTrack)(Select);
exportedSelect.Option = _option2.default;
exportedSelect.OptGroup = _select2.default.OptGroup;

exports.default = exportedSelect;

/***/ }),

/***/ "./src/components/Select/style/option.js":
/*!***********************************************!*\
  !*** ./src/components/Select/style/option.js ***!
  \***********************************************/
/*! no static exports found */
...
var StyledOption = (0, _styledComponents2.default)(_select.Option)(_templateObject);

exports.default = StyledOption;
...
var StyledSelect = (0, _styledComponents2.default)(_select2.default)(_templateObject);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "rect",
          { x: "0", y: "13", width: "2.5", height: "5", fill: fill },
        ...
        _react2.default.createElement(
          "rect",
          { x: "5", y: "13", width: "2.5", height: "5", fill: fill },
          _react2.default.createElement("animate", {
            attributeName: "height",
            attributeType: "XML",
            values: "5;21;5",
        ...
        _react2.default.createElement(
          "rect",
          { x: "10", y: "13", width: "2.5", height: "5", fill: fill },
          _react2.default.createElement("animate", {
            attributeName: "height",
            attributeType: "XML",
            values: "5;21;5",
...
exports.Select = exports.Input = exports.TrackingProvider = exports.StyleProvider = exports.ButtonGroup = exports.Button = undefined;

var _Button = __webpack_require__(/*! ./components/Button */ "./src/components/Button/index.js");

var _Button2 = _interopRequireDefault(_Button);

var _ButtonGroup = __webpack_require__(/*! ./components/ButtonGroup */ "./src/components/ButtonGroup/index.js");

var _ButtonGroup2 = _interopRequireDefault(_ButtonGroup);

var _Input = __webpack_require__(/*! ./components/Input */ "./src/components/Input/index.js");
...
var _StyleProvider = __webpack_require__(/*! ./providers/StyleProvider */ "./src/providers/StyleProvider/index.js");
...
exports.TrackingProvider = _TrackingProvider.TrackingProvider;
 ...
 */
var StyleProvider = function (_React$PureComponent) {
  _inherits(StyleProvider, _React$PureComponent);
...
var _context = __webpack_require__(/*! ./context */ "./src/providers/TrackingProvider/context.js");
 ...
 */
var TrackingProvider = function (_React$Component) {
  _inherits(TrackingProvider, _React$Component);

  function TrackingProvider(props) {
    _classCallCheck(this, TrackingProvider);

    var _this = _possibleConstructorReturn(this, (TrackingProvider.__proto__ || Object.getPrototypeOf(TrackingProvider)).call(this));

    _this.track = function (event, value) {
...
exports.default = TrackingProvider;
...
exports.TrackingProvider = exports.withTrack = undefined;

var _withTrack = __webpack_require__(/*! ./withTrack */ "./src/providers/TrackingProvider/withTrack.js");

var _withTrack2 = _interopRequireDefault(_withTrack);

var _Provider = __webpack_require__(/*! ./Provider */ "./src/providers/TrackingProvider/Provider.js");

var _Provider2 = _interopRequireDefault(_Provider);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.withTrack = _withTrack2.default;
exports.TrackingProvider = _Provider2.default;
...
function withTrack(WrappedComponent) {
  return function (_React$PureComponent) {
    _inherits(TrackingConsumer, _React$PureComponent);

    function TrackingConsumer() {
      _classCallCheck(this, TrackingConsumer);

      return _possibleConstructorReturn(this, (TrackingConsumer.__proto__ || Object.getPrototypeOf(TrackingConsumer)).apply(this, arguments));
    }

    _createClass(TrackingConsumer, [{
      key: 'render',
      value: function render() {
        var _this2 = this;
        ...
        return _react2.default.createElement(
          ...
          null,
          function (track) {
            return _react2.default.createElement(WrappedComponent, _extends({ track: track }, _this2.props));
          }
        );
      }
    }]);
